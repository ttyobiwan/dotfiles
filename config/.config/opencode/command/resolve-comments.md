...
- First output the report; only implement local changes after user approval.
...
4) Output a Markdown report (do this even if you make no changes):
...
5) Ask for approval to proceed with changes.
6) After approval, address locally:
